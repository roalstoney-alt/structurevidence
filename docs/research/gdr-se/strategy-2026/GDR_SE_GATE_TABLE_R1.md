...
| G2_RTP_PROVENANCE | PARTIAL | HARD | validate_g2_provenance | GDR_SE_RUNTIME_RULES_v0.1-R1 | Required artifacts exist and are hashed, but legacy records do not carry all expected hashes. |
| G3_EVIDENCE_FRESHNESS | UNRESOLVED | SOFT | validate_g3_freshness | GDR_SE_RUNTIME_RULES_v0.1-R1 | RDL freshness policy not configured for category CORPORATE_TREASURY. |
...
| G5_NUMERICAL_RECONCILIATION | NOT_APPLICABLE | SOFT | validate_g5_numerical | GDR_SE_RUNTIME_RULES_v0.1-R1 | No profile-required numerical reconciliation artifact exists for this legacy profile. |
...
| G7_COUNTER_EVIDENCE_COMPLETENESS | PARTIAL | HARD | validate_g7_counter_evidence | GDR_SE_RUNTIME_RULES_v0.1-R1 | Legacy counter-evidence is prose, not a structured targeted log. |
| G8_INDEPENDENT_REVIEW | NOT_APPLICABLE | SOFT | validate_g8_review | GDR_SE_RUNTIME_RULES_v0.1-R1 | Independent review is not required for this profile. |
...
Input Bundle SHA-256: `45c92ba47075258bfca67686b007aaf168a891a4d8ad59fda8d53a462741bb27`
