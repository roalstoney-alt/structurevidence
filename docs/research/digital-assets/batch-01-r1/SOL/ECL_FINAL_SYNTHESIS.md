# SOL R1 ECL Final Synthesis

Why this state?
POTENTIAL_CONFLICT is selected because the public evidence set is reconcilable only after preserving dates, implementation status and source authority boundaries.
...
Source dependency
PARTIAL source coverage limits confidence.
