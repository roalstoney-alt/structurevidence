...
<html lang="en">
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Dynamics - StructureEvidence</title><meta name="description" content="Structural Dynamics and Evidence Dynamics timeline model for StructureEvidence subjects."><link rel="canonical" href="https://structurevidence.org/dynamics.html"><link rel="stylesheet" href="assets/style.css"></head>
<body>{nav()}<main>
