...
def main() -> None:
    ...
    if gate(evaluate(resolve("BNB", ROOT), ROOT, as_of="2027-09-10T00:00:00Z"), "G3_EVIDENCE_FRESHNESS")["status"] != "UNRESOLVED":
        fail("UNCONFIGURED freshness should remain unresolved at any as_of")
