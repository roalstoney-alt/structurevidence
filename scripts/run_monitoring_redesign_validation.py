...
def main() -> int:
    ...
    public_files = ["index.html", "monitor.html", "verify.html", "reports.html", "sample-report.html", "paid-pilot.html", "enterprise.html", "customize.html", "checkout.html"]
    ...
    checks: dict[str, tuple[bool, list[str], str]] = {
        ...
        "MON40_PAYMENT_READINESS_HONESTY": ("PAYMENT_ENABLED: true / MANUAL_CONFIRMATION" in access and "Automated private download is not active" in access, ["paid-pilot.html", "commercial/config/commercial.json"], "Manual payment is active while automated fulfillment remains disabled."),
