...
GATE_IDS = [f"MON{i:02d}_{name}" for i, name in enumerate([
    ...
    "BNB_SEARCH_JOURNEY", "ASSET_STATE_TABLE", "STATE_TRANSITION_TIMELINE", "EVENT_LEDGER_UI",
...
def main() -> int:
    ...
    checks: dict[str, tuple[bool, list[str], str]] = {
        ...
        "MON29_MONITOR_FIRST_HOME": ("open a monitored subject" in home.lower() and "asset states" in home.lower(), ["index.html"], "First screen is the monitoring product."),
        ...
        "MON31_ASSET_STATE_TABLE": (all(subject in home for subject in ["BNB", "SOL", "TRX", "XLM", "MSTR"]), ["index.html"], "Coverage table includes five subjects."),
