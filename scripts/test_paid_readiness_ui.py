...
ROUTES = [ROOT / "index.html", ROOT / "cases/800vdc/index.html", ROOT / "verify/index.html", ROOT / "decision-pack/index.html", ROOT / "context/index.html"]
...
class PaidReadinessUITest(unittest.TestCase):
    ...
    def test_required_form_fields(self):
        verify = ROUTES[2].read_text()
        context = ROUTES[4].read_text()
