...
def asset_page(asset: str, in_docs: bool) -> str:
    ...
    <head>
      ...
      <title>{asset} - StructureEvidence</title>
      <meta name="description" content="StructureEvidence public structural and evidence research page for {asset}.">
